...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Hotel, method_decorators= method_decorators)
    api.expose_object(database.models.Guest, method_decorators= method_decorators)
    api.expose_object(database.models.MaintenanceRequest, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.ReservationService, method_decorators= method_decorators)
