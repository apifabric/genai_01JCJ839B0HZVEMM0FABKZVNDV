...
@Component({
  selector: 'ReservationService-home',
  templateUrl: './ReservationService-home.component.html',
  styleUrls: ['./ReservationService-home.component.scss']
})
export class ReservationServiceHomeComponent implements AfterViewInit {
