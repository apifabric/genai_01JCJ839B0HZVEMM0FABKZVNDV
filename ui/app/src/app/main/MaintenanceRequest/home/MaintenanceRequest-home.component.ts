...
@Component({
  selector: 'MaintenanceRequest-home',
  templateUrl: './MaintenanceRequest-home.component.html',
  styleUrls: ['./MaintenanceRequest-home.component.scss']
})
export class MaintenanceRequestHomeComponent implements AfterViewInit {
