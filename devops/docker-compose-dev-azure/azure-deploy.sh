...
resourcename="hotelmgmt"  # lower case, only
resourcegroup="hotelmgmt_rg"
...
# git clone https://github.com/apilogicserver/hotelmgmt.git
# cd hotelmgmt
...
az group create --name hotelmgmt_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group hotelmgmt_rg --sku S1 --is-linux
az container create --resource-group hotelmgmt_rg --name hotelmgmt --image apilogicserver/hotelmgmt:latest --dns-name-label hotelmgmt --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//hotelmgmt.westus.azurecontainer.io:5656'
